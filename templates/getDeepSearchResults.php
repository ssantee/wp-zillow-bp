    ...
    function zillow_bp_tgetDeepSearchResults($data){
        ...
        $template = <<<EOT
            <div role="tabpanel" class="tab-pane row active clearfix" id="wpz-deepsearchresults">
                ...
                <div class="wp-z-bp-section clearfix details">
                    <h3>Details</h3>
                    <ul>
                ...
                <div class="wp-z-bp-section clearfix zestimate">
                ...
                <div class="wp-z-bp-section clearfix localrealestate">
                ...
                <div class="wp-z-bp-section clearfix zillowlinks">
                    <h3>Links</h3>
                    <ul>
